...
INSERT INTO Artists (artist_id, artist_name) VALUES
  ...
  SELECT album_name, artist_name FROM Artists RIGHT JOIN Albums ON Artists.artist_id = ALbums.artist_id;
  SELECT album_name, artist_name FROM Artists FULL JOIN Albums ON Artists.artist_id = ALbums.artist_id;
